...
KEY = "6fcae819c7314fb9ace9a4c18a01d83e"

# This endpoint will be used in all examples in this quickstart.
ENDPOINT = "https://gascofacerecog.cognitiveservices.azure.com/"
# </snippet_subvars>

# <snippet_verify_baseurl>
# Base url for the Verify and Facelist/Large Facelist operations
IMAGE_BASE_URL = 'https://github.com/Azure-Samples/cognitive-services-sample-data-files/tree/fe7cb80827112acbc4180b834b850cbe9179871c/Face/images'
# </snippet_verify_baseurl>
...
single_image_path = 'path_to_your_image_file'  # replace with your file path
single_image_name = os.path.basename(single_image_path)

# Modified code with local file
with open(r"C:\Users\dbigman\OneDrive - SUDOC LLC\Pictures\Dan.png", 'rb') as image_file:
    detected_faces = face_client.face.detect_with_stream(image=image_file, detection_model='detection_03')


# Original code with URL
...
if not detected_faces:
    raise Exception('No face detected from image {}'.format('Dan.png'))
